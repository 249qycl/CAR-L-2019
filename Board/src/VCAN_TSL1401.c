...
//配置CCD管脚(调试器的 V2.1版本，ADC通道改成B0~B5管脚)
//                          CCD1            CCD2        CCD3
ADCn_Ch_e   tsl1401_ch[] = {ADC1_SE8,     ADC0_SE12,    ADC1_SE10};       //CCD所用的 原始信号 ADC通道
//ADCn_Ch_e   tsl1401_ch[] = {ADC1_SE9,     ADC0_SE13,    ADC1_SE11};       //CCD所用的 放大信号 ADC通道
