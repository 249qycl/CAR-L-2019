...
float a;
/*填入虚拟示波器变量名*/
#define INV_PARAM0 (Ecc_Car->Dir_Error * 100)
#define INV_PARAM1 (Ecc_Car->Delta_err * 100)
#define INV_PARAM2 (Ecc_Car->S_Duty)
#define INV_PARAM3 (param.P_adj)
#define INV_PARAM4 (param.D_adj)
#define INV_PARAM5 (0)
#define INV_PARAM6 (0)
#define INV_PARAM7 (0)
#define INV_PARAM8 (0)
